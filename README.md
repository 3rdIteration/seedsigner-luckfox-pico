...
We have forked the [LuckFox Pico SDK](https://github.com/3rdIteration/luckfox-pico/tree/copilot/enable-glibc-highest-version) in order to enable various hardware features like pull-up resistors, adjust video RAM, and other things.
